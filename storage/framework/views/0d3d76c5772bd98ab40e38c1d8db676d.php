<div
    ...
    <div class="relative mt-2 rounded-md shadow-sm w-full">
        ...
        <input wire:click="copyReferCode()" type="text" name="convite" id="convite"
            ...
            placeholder="Link de convite" value="<?php echo e(url('/home/game/register?code=' . auth()->user()->inviter_code)); ?>" />
    </div>
</div>
<?php /**PATH /home/u859854438/domains/girocapital.fun/public_html/resources/views/filament/components/convite.blade.php ENDPATH**/ ?>