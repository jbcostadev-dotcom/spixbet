                ...
                Section::make('Gateways')
                    ...
                    ->schema([
                        Select::make('default_gateway')
                            ...
                            ->options([
                                'suitpay' => 'Divpag', // ← Renomeado de SuitPay para Divpag
                                // 'bspay' => 'Bspay', // ← BsPay oculto
                            ])
                            ->columnSpanFull(),
                        
                        Toggle::make('suitpay_is_enable')
                            ->label('Divpag Ativo'), // ← Renomeado de SuitPay Ativo para Divpag Ativo
                        
                        // Toggle::make('bspay_is_enable')
                        //     ->label('BsPay Ativo'), // ← BsPay oculto
